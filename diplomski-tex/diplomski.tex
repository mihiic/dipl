...
koriste tehniku iscrtavanja prikaza sa različitom razinom detalja. Kod ovakvog pristupa, 
objekti koji su daleko od kamere koriste modele sa izrazito malo datalja, a kod objekata 
...
isti model potrebno napraviti nekoliko različitih modela sa različitom razinom detalja, što 
...
\paragraph{}
Fizički sustav opisan u cijelini 3 možemo opisati kosturom od dvije kosti. Prva kost 
...
je dijete prve kosti i rotirana je na način da uvijek gleda u smjeru vektora između tijela 1 
i tijela 2.
...
na pojedine točke u prostoru, na način da je kost uvijek bude unutar volumena koje te točke 
...
množenjem pozicije točke sa matricom kosti.
...
usporediti njihov utjecaj na simulaciju sa ponašanjem u stvarnom svijetu.
...
\paragraph{}
Utjecaj paramatara na simulaciju opisan je u poglavlju \ref{physics_model_eval}.
...
gotovo svaku biljku moguće vrlo jednostavno opisati sa par pravila. Model simulacije vjetra 
...
različitim atomosferskim utjecajima je kompleksan matematički problem. Promatranjem izgleda 
...
sustav simulacije vjetra. Ocjenjeni su i prezentirani rezultati. Istražene su neke 
